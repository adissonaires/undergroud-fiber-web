...
export const demoCourseSteps = [
    ...
    {
        order: 2,
        title: 'Create a Firebase underground-fiber and Set up your app',
        subtitle:
            'How to create a basic Firebase underground-fiber and how to run it locally',
    ...
    },
    {
        ...
        subtitle: 'How to build, push and run the underground-fiber remotely',
